...
قابلیت تهیه نسخه پشتیبان (Backup) و بازیابی (Restore) به پنل افزوده شد. از این پس می‌توانید تنها با یک کلیک، بکاپ خود را دانلود کرده و به‌سادگی آن را روی سرور جدید آپلود و بازیابی نمایید.
