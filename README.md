...
امکان تهیه نسخه پشتیبان (Backup) و بازگردانی (Restore) به پنل اضافه شد. اکنون می‌توانید تنها با فشردن یک دکمه، نسخه پشتیبان را دانلود کرده و به‌راحتی آن را روی سرور جدید آپلود و بازیابی کنید.
