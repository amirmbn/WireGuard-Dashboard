...
امکان مشاهده حجم مصرف شده کاربر فراهم شد یک نوار افقی برای نمایش درصد مصرف به پنل اضافه شد.

امکان تهیه نسخه پشتیبان (Backup) و بازگردانی (Restore) به پنل اضافه شد. اکنون می‌توانید تنها با فشردن یک دکمه در انتهای بخش تنظیمات پنل، نسخه پشتیبان را دانلود کرده و به‌راحتی آن را روی سرور جدید آپلود و بازیابی کنید.

سیستم عامل های قابل استفاده: اوبونتو 20+ / دبیان 11+ ( توصیه شده: اوبونتو 22 )
<br>
<br>
...
- می‌توانید از تانل فوروارد [Natix](https://github.com/amirmbn/Natix) هم استفاده کنید؛ این ابزار امکان تنظیم MTU و DNS را هم دارد.
</div><br>
...
- پورت وایرگارد در اینجا 1080 است، میتوانید پورت دیگری انتخاب کنید
